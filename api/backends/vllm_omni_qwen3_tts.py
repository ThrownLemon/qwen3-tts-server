...
class VLLMOmniQwen3TTSBackend(TTSBackend):
    ...
    async def generate_voice_clone(
        ...
        """Voice cloning not supported in vLLM-Omni backend."""
        raise NotImplementedError(
            "Voice cloning is not supported with the vLLM-Omni backend. "
            "Use the official backend (TTS_BACKEND=official) for voice cloning."
        )
    ...
    async def generate_voice_design(
        ...
        """Voice design not supported in vLLM-Omni backend."""
        raise NotImplementedError(
            "Voice design is not supported with the vLLM-Omni backend. "
            "Use the official backend (TTS_BACKEND=official) for voice design."
        )
